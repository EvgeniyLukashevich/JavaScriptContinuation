# Lecture 7. Practice 
###### Работа находится в каталоге `last_lecture_and_audio`  

Просто попробовал попрактиковаться в добавлении кастомной визуализации для элементов контроля аудио, геолокации, скролле и перетаскивании
...
Попробовал реализовать добавление товара не в раздел под карточками, а в выпадающее меню корзины. Также постарался реализовать удаление товара из корзины, изменение количества товара, просчёт общей суммы товаров в корзине, отлавливание дубликатов и при попытке добавления дубликата - увеличение количества данного товара на 1.
